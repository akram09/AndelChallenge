...
data class Product(val name:String , val price:Int , val description:String , val imageUrl:String)
        ...
        if(!binding.name.text.isNullOrBlank() && !binding.description.text.isNullOrBlank() && !binding.price.text.isNullOrBlank() && uri!=null) {
            ...
            try {
                ...
                if(!entered ){
                    ...
                    Toast.makeText(this , "The price must be a number" , Toast.LENGTH_LONG).show()
                }
            }
        }else{
